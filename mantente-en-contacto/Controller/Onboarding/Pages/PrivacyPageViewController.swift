...
class PrivacyPageViewController: UIViewController, OnboardingPageContent {
    ...
    private let titleLabel: UILabel = {
        let label = UILabel()
        label.text = "Tu privacidad es lo más importante"
    ...
    private let contentLabel: UILabel = {
        let label = UILabel()
        label.text = """
            La app no comparte tu ubicación todo el tiempo, solo notifica la primera vez que llegas a tu destino.
            """
    ...
    private let imageView: UIImageView = {
        ...
        imageView.image = UIImage(named: "onboardingPrivacy")
